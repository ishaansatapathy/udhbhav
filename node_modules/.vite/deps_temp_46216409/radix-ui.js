...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React76 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React76.useState, useEffect40 = React76.useEffect, useLayoutEffect6 = React76.useLayoutEffect, useDebugValue = React76.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React34.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime15.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React34.isValidElement(newElement) ? React34.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable3(child) {
  return React34.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER3;
}
...
var DialogTrigger = React35.forwardRef(
  (props, forwardedRef) => {
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime16.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React35.Children.map(children, (child) => (0, import_jsx_runtime16.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime16.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
DialogPortal.displayName = PORTAL_NAME2;
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React35.forwardRef(
  (props, forwardedRef) => {
...
var DialogOverlayImpl = React35.forwardRef(
  (props, forwardedRef) => {
...
var DialogContentModal = React35.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME3, props.__scopeDialog);
    const contentRef = React35.useRef(null);
...
var DialogContentNonModal = React35.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME3, props.__scopeDialog);
...
var DialogContentImpl = React35.forwardRef(
  (props, forwardedRef) => {
...
var DialogTitle = React35.forwardRef(
  (props, forwardedRef) => {
...
var DialogDescription = React35.forwardRef(
  (props, forwardedRef) => {
...
var DialogClose = React35.forwardRef(
  (props, forwardedRef) => {
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React36.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime17.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React36.isValidElement(newElement) ? React36.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React47.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime25.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React47.isValidElement(newElement) ? React47.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React47.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var ContextMenuTrigger = React49.forwardRef(
  (props, forwardedRef) => {
    const { __scopeContextMenu, disabled = false, ...triggerProps } = props;
    const context = useContextMenuContext(TRIGGER_NAME6, __scopeContextMenu);
    const menuScope = useMenuScope(__scopeContextMenu);
    const pointRef = React49.useRef({ x: 0, y: 0 });
    const virtualRef = React49.useRef({
      getBoundingClientRect: () => DOMRect.fromRect({ width: 0, height: 0, ...pointRef.current })
    });
    const longPressTimerRef = React49.useRef(0);
    const clearLongPress = React49.useCallback(
    ...
    React49.useEffect(() => clearLongPress, [clearLongPress]);
    React49.useEffect(() => void (disabled && clearLongPress()), [disabled, clearLongPress]);
...
var ContextMenuContent = React49.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuGroup = React49.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuLabel = React49.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuItem = React49.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuCheckboxItem = React49.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioGroup = React49.forwardRef((props, forwardedRef) => {
...
var ContextMenuRadioItem = React49.forwardRef((props, forwardedRef) => {
...
var ContextMenuItemIndicator = React49.forwardRef((props, forwardedRef) => {
...
var ContextMenuSeparator = React49.forwardRef((props, forwardedRef) => {
...
var ContextMenuArrow = React49.forwardRef(
  (props, forwardedRef) => {
...
var ContextMenuSubTrigger = React49.forwardRef((props, forwardedRef) => {
...
var ContextMenuSubContent = React49.forwardRef((props, forwardedRef) => {
...
var NAME5 = "Label";
var Label3 = React51.forwardRef((props, forwardedRef) => {
...
var Form = React52.forwardRef(
  (props, forwardedRef) => {
    ...
    const formRef = React52.useRef(null);
    const composedFormRef = useComposedRefs(forwardedRef, formRef);
    const [validityMap, setValidityMap] = React52.useState({});
    const getFieldValidity = React52.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React52.useCallback(
    ...
    const handleFieldValiditionClear = React52.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React52.useState({});
    const getFieldCustomMatcherEntries = React52.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React52.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React52.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React52.useState({});
    const getFieldCustomErrors = React52.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React52.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React52.useState({});
    const handleFieldMessageIdAdd = React52.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React52.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React52.useCallback(
...
var FormControl = React52.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React52.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React52.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormBuiltInMessage = React52.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React52.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React52.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React52.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React52.forwardRef(
  (props, forwardedRef) => {
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React53.useRef(false);
  const isPointerDownOnContentRef = React53.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React53.useCallback(() => setOpen(false), [setOpen]);
  React53.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardTrigger = React53.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContent = React53.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React53.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React53.useState(false);
  React53.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React53.forwardRef(
  (props, forwardedRef) => {
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React58.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime36.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React58.isValidElement(newElement) ? React58.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React63.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime42.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React63.isValidElement(newElement) ? React63.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React67.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime46.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React67.isValidElement(newElement) ? React67.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Toolbar = React73.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarSeparator = React73.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React73.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarLink = React73.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleGroup = React73.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React73.forwardRef(
  (props, forwardedRef) => {
...
function createSlot9(ownerName) {
  ...
  const Slot22 = React74.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime53.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React74.isValidElement(newElement) ? React74.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable9(child) {
  return React74.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React75.useRef(true);
  const isPointerInTransitRef = React75.useRef(false);
  ...
  return (0, import_jsx_runtime54.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React75.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React75.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React75.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React75.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React75.useMemo(() => {
  ...
  return (0, import_jsx_runtime54.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime54.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React75.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React75.useCallback(() => {
...
var TooltipTrigger = React75.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React75.useRef(false);
    const hasPointerMoveOpenedRef = React75.useRef(false);
    const handlePointerUp = React75.useCallback(() => isPointerDownRef.current = false, []);
    React75.useEffect(() => {
...
var TooltipContent = React75.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React75.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React75.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React75.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React75.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React75.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React75.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React75.forwardRef(
  (props, forwardedRef) => {
